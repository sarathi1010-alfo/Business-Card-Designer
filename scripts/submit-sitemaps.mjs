...
const newUrls = [
  ...
  `https://${DOMAIN}/blog/industry-specific-digital-cards`,
  ...
  `https://${DOMAIN}/use-cases/gallery-opening-digital-card`,
  `https://${DOMAIN}/templates/architectural-digital-business-card`,
