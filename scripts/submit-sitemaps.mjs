...
const newUrls = [
  ...
  `https://${DOMAIN}/use-cases/medical-conference-digital-card`,
  `https://${DOMAIN}/use-cases/legal-summit-digital-card`,
  `https://${DOMAIN}/templates/medical`,
  `https://${DOMAIN}/templates/legal`
];
