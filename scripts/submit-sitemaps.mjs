...
const newUrls = [
  ...
  `https://${DOMAIN}/professions/musician-digital-business-card`,
  `https://${DOMAIN}/use-cases/tech-meetup-digital-card`,
  `https://${DOMAIN}/use-cases/trade-show-digital-business-card`,
