...
const newUrls = [
  ...
  `https://${DOMAIN}/use-cases/b2b-sales-digital-business-card`,
  `https://${DOMAIN}/templates/corporate-digital-business-card`,
  `https://${DOMAIN}/templates/modern-digital-business-card`
