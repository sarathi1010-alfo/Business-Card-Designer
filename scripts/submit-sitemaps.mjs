...
const newUrls = [
  ...
  `https://${DOMAIN}/blog/how-to-design-a-digital-business-card`,
  `https://${DOMAIN}/blog/ultimate-guide-to-digital-business-cards`,
  `https://${DOMAIN}/blog/how-digital-business-cards-work`,
  `https://${DOMAIN}/blog/why-you-need-a-digital-business-card`,
  `https://${DOMAIN}/blog/what-is-a-qr-code-business-card`
];
