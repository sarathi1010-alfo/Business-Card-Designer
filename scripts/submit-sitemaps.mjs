...
const INDEXNOW_KEY = process.env.INDEXNOW_KEY || '5a4c514838db4db1a7f14b609db20573'; // Example key, ideally from env
...
const newUrls = [
  ...
  `https://${DOMAIN}/blog/why-do-i-need-digital-business-card`,
