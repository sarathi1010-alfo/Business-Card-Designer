...
const newUrls = [
  ...
  `https://${DOMAIN}/blog/industry-specific-networking`,
  ...
  `https://${DOMAIN}/professions/agent-digital-business-card`,
  `https://${DOMAIN}/use-cases/trade-show-digital-card`,
  `https://${DOMAIN}/use-cases/investor-pitch-digital-business-card`,
