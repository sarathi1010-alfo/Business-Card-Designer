...
const newUrls = [
  ...
  `https://${DOMAIN}/blog/industry-networking-digital-card-guide`,
  ...
  `https://${DOMAIN}/use-cases/seminar-digital-business-card`,
  `https://${DOMAIN}/templates/professional-digital-business-card`,
