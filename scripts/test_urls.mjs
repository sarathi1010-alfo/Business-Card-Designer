...
(async () => {
  ...
  const urlsToTest = [
    ...
    '/blog/industry-networking-digital-card-guide',
    '/professions/lawyer-digital-business-card',
    '/professions/architect-digital-business-card',
    '/professions/chef-digital-business-card',
    '/professions/doctor-digital-business-card',
    '/use-cases/trade-show-digital-card',
    '/use-cases/seminar-digital-business-card',
    '/templates/professional-digital-business-card',
