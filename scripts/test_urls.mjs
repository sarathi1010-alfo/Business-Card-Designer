...
(async () => {
  ...
  const urlsToTest = [
    ...
    '/professions/therapist-digital-business-card',
    '/use-cases/creative-agency-digital-card',
    '/use-cases/client-meeting-digital-card',
    '/templates/dark-mode-digital-business-card',
    '/templates/colorful-digital-business-card'
  ];
