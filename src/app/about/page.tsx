  ...
  return (
    <div className="container mx-auto px-4 py-16 max-w-4xl">
      ...
      <div className="prose dark:prose-invert max-w-none text-lg">
        ...
        <p className="mb-6">
          From designing business cards to compressing PDFs, every tool in our ecosystem is built with a focus on speed, privacy, and user experience. Check out our growing suite of utilities below, and read our <Link href="/blog/digital-business-card-converts-guide">guide on creating high-converting digital cards</Link> to learn how to make the most of your new digital presence.
        </p>
      </div>
    </div>
  );
