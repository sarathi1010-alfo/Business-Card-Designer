  ...
  return (
    <div className="container mx-auto px-4 py-16 max-w-4xl">
      ...
      <div className="prose dark:prose-invert max-w-none text-lg">
        ...
        <p className="mb-6">
          From designing business cards to compressing PDFs, every tool in our ecosystem is built with a focus on speed, privacy, and user experience. Check out our growing suite of utilities below. To learn more about maximizing your professional connections, read our <Link href="/blog/industry-networking-guide" className="text-primary hover:underline">Ultimate Guide to Industry-Specific Networking</Link>.
        </p>
      </div>
    </div>
  );
