  ...
  return (
    <div className="container mx-auto px-4 py-16 max-w-4xl">
      ...
      <div className="prose dark:prose-invert max-w-none text-lg">
        ...
        <p className="mb-6">
          From designing business cards to compressing PDFs, every tool in our ecosystem is built with a focus on speed, privacy, and user experience. We also believe in providing context, such as our <a href="/blog/industry-specific-networking-guide" className="text-primary hover:underline">guide on industry-specific networking</a> to help you get the most out of our tools. Check out our growing suite of utilities below.
        </p>
      </div>
    </div>
  );
