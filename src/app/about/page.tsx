  ...
  return (
    <div className="container mx-auto px-4 py-16 max-w-4xl">
      ...
      <div className="prose dark:prose-invert max-w-none text-lg">
        ...
        <p className="mb-6">
          From designing business cards to compressing PDFs, every tool in our ecosystem is built with a focus on speed, privacy, and user experience. For instance, you can learn about the <Link href="/blog/design-psychology-digital-business-cards" className="text-primary hover:underline font-medium">design psychology for digital business cards</Link> that informs our template creation. Check out our growing suite of utilities below.
        </p>
      </div>
    </div>
  );
