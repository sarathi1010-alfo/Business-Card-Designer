  ...
  return (
    <div className="container mx-auto px-4 py-16 max-w-4xl">
      ...
      <div className="prose dark:prose-invert max-w-none text-lg">
        ...
        <p className="mb-6">
          From designing business cards to compressing PDFs, every tool in our ecosystem is built with a focus on speed, privacy, and user experience. Check out our growing suite of utilities below, and learn how to maximize your results with our <a href="/blog/digital-business-card-guide" className="text-primary hover:underline font-medium">digital business card guide</a>.
        </p>
      </div>
    </div>
  );
