  ...
  return (
    <div className="container mx-auto px-4 py-16 max-w-4xl">
      ...
      <div className="prose dark:prose-invert max-w-none text-lg">
        ...
        <h2 className="text-2xl font-semibold mt-10 mb-4">Design Philosophy</h2>
        <p className="mb-6">
          We believe in the power of design psychology to improve digital interactions. For a deeper dive into our approach, read our guide on <Link href="/blog/design-psychology-digital-business-card" className="text-primary hover:underline">How Design Psychology Improves Digital Business Cards</Link>.
