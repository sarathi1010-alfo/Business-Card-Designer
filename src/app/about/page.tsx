  ...
  return (
    <div className="container mx-auto px-4 py-16 max-w-4xl">
      ...
      <div className="prose dark:prose-invert max-w-none text-lg">
        ...
        <p className="mb-6">
          From designing business cards to compressing PDFs, every tool in our ecosystem is built with a focus on speed, privacy, user experience, and <Link href="/blog/design-psychology-digital-business-cards" className="text-primary hover:underline">design psychology</Link>. Check out our growing suite of utilities below.
        </p>
      </div>
    </div>
  );
