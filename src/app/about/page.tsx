  ...
  return (
    <div className="container mx-auto px-4 py-16 max-w-4xl">
      ...
      <div className="prose dark:prose-invert max-w-none text-lg">
        ...
        <p className="mb-6">
          From designing business cards to compressing PDFs, every tool in our ecosystem is built with a focus on speed, privacy, and user experience. Check out our growing suite of utilities below, or read our latest guide on <a href="/blog/digital-business-card-guide" className="text-primary hover:underline">how to create a digital business card that converts</a>.
        </p>
      </div>
    </div>
  );
