      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-card text-card-foreground shadow-sm rounded-lg border overflow-hidden">
          <div className="p-6">
            <h2 className="text-2xl font-semibold mb-2">
              <Link href="/blog/ultimate-guide-digital-business-cards-2026" className="hover:underline">
                The Ultimate 2026 Guide to Professional Networking
              </Link>
            </h2>
            <p className="text-muted-foreground mb-4">
              Learn everything about digital business cards, professional networking, and how to maximize your reach in 2026.
            </p>
        ...
        <div className="bg-card text-card-foreground shadow-sm rounded-lg border overflow-hidden">
          <div className="p-6">
            ...
            <p className="text-muted-foreground mb-4">
              Learn exactly how digital business cards function, from QR code scanning to data transfer and analytics.
            </p>
        ...
        <div className="bg-card text-card-foreground shadow-sm rounded-lg border overflow-hidden">
          <div className="p-6">
            ...
            <p className="text-muted-foreground mb-4">
              Discover the top reasons why professionals in every industry need a digital business card in 2026.
            </p>
        ...
        <div className="bg-card text-card-foreground shadow-sm rounded-lg border overflow-hidden">
          <div className="p-6">
            ...
            <p className="text-muted-foreground mb-4">
              Learn what a QR code business card is, how dynamic QR codes work, and why they are replacing traditional networking.
            </p>
